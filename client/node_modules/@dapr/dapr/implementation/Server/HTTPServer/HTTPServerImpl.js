...
class HTTPServerImpl {
     ...
     */
    extractDataFromSubscribeRequest(req) {
        var _a;
    ...
    registerPubsubSubscription(pubsubName, topic, options = {}) {
        ...
        for (const route of Object.keys(subscription.routes)) {
            ...
            this.server.post(`/${routeObj.path}`, (req, res) => __awaiter(this, void 0, void 0, function* () {
                var _a;
                const bulkSubEnabled = (_a = subscription.dapr.bulkSubscribe) === null || _a === void 0 ? void 0 : _a.enabled;
                if (bulkSubEnabled) {
                    const result = yield this.processBulkSubscribeMessage(routeObj, req);
        ...
        this.logger.info(`[Topic = ${topic}] Registered Subscription with routes: ${Object.keys(subscription.routes).join(", ")}`);
    }
    processBulkSubscribeMessage(routeObj, req) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const resArr = [];
            // @ts-ignore
            const entries = (_a = req === null || req === void 0 ? void 0 : req.body) === null || _a === void 0 ? void 0 : _a.entries;
