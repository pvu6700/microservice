...
class HTTPServerActor {
    ...
    getRegisteredActors() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ActorRuntime_1.default.getInstance(this.client.daprClient).getRegisteredActorTypes();
        });
    }
    /**
    ...
    handlerDeactivate(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield ActorRuntime_1.default.getInstance(this.client.daprClient).deactivate(actorTypeName, actorId);
    ...
    handlerTimer(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = req.body;
            const dataSerialized = this.serializer.serialize(body);
            const result = yield ActorRuntime_1.default.getInstance(this.client.daprClient).fireTimer(actorTypeName, actorId, timerName, dataSerialized);
    ...
    handlerReminder(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = req.body;
            const dataSerialized = this.serializer.serialize(body);
            const result = yield ActorRuntime_1.default.getInstance(this.client.daprClient).fireReminder(actorTypeName, actorId, reminderName, dataSerialized);
            return res.status(200).send(result);
        });
    }
