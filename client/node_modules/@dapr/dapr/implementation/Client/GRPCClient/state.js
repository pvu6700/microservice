...
class GRPCClientState {
    ...
    save(storeName, stateObjects, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const stateObject of stateObjects) {
                ...
                if (stateObject === null || stateObject === void 0 ? void 0 : stateObject.etag) {
                    const etag = new common_pb_1.Etag();
                    etag.setValue(stateObject.etag);
                    si.setEtag(etag);
                }
                si.setOptions(this._configureStateOptions(stateObject === null || stateObject === void 0 ? void 0 : stateObject.options));
    ...
    get(storeName, key, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options === null || options === void 0 ? void 0 : options.consistency) {
    ...
    getBulk(storeName, keys, options = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            msgService.setParallelism((_a = options.parallelism) !== null && _a !== void 0 ? _a : Settings_util_1.Settings.getDefaultStateGetBulkParallelism());
    ...
    transaction(storeName, operations = [], metadata = null) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const o of operations) {
                ...
                si.setOptions(this._configureStateOptions((_a = o.request) === null || _a === void 0 ? void 0 : _a.options));
    ...
    _configureStateOptions(opt) {
        ...
        if (opt === null || opt === void 0 ? void 0 : opt.consistency) {
            stateOptions.setConsistency(opt.consistency);
        }
        if (opt === null || opt === void 0 ? void 0 : opt.concurrency) {
