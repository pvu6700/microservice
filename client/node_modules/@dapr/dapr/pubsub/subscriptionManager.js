...
class SubscriptionManager {
    ...
    isTopicRegistered(pubsub, topic) {
        var _a;
        return ((_a = this.subscriptions[pubsub]) === null || _a === void 0 ? void 0 : _a[topic]) !== undefined;
    }
    /**
    ...
    getSubscription(pubsub, topic) {
        var _a;
        return (_a = this.subscriptions[pubsub]) === null || _a === void 0 ? void 0 : _a[topic];
    }
    /**
    ...
    getRegisteredTopics(pubsub) {
        var _a;
        return Object.keys((_a = this.subscriptions[pubsub]) !== null && _a !== void 0 ? _a : {});
    }
    /**
    ...
    generateDaprSubscription(pubsub, topic, options = {}) {
        ...
        if (typeof options.route === "object") {
            const routes = {
                ...
                rules: (_a = options.route.rules) === null || _a === void 0 ? void 0 : _a.map((rule) => ({
                    match: rule.match,
